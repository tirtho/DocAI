...
export COSMOS_CONTAINER=<put-your-COSMOS-CONTAINER-name-here>
export BING_KEY=<put-your-bing-web-search-api-key-here>
...
export WEBAPP_NAME=<name your web app to create/update>
export REGION=<region where app service will deploy>
