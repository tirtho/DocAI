...
// param accountName string = 'docai-dev-cosmosdb-${uniqueString(resourceGroup().id)}'
...
param databaseName string = 'DocAIDatabase'

@description('The name for the container')
param containerName string = 'EmailExtracts'
